...
def signature():
    ...
    sig = get_sig_version({
        ...
        (6, 7, 7, 10): '8c6ef1dcb1bacb6ad8edf307f2f2c6a129b3b7aa262ee288325f9fd334006374',
    })
    with Image(filename=asset('mona-lisa.jpg')) as img:
...
def watermark():
    ...
    sig = get_sig_version({
        ...
        (6, 7, 7, 10): '74e25abb7dfcda955b57e5348b91ce73a160a40b4029f84e6beb73b14e99d566',
    })
    with Image(filename=asset('beach.jpg')) as img:
...
def reset_coords():
    ...
    sig = get_sig_version({
        ...
        (6, 7, 7, 10): 'e8ea17066378085a60f7213430af62c89ed3f416e98b39f2d434c96c2be82989',
    })
